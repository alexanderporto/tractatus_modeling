...
# filter top terms for each topic (10 most probable terms per topic)
...
# reshape to wide format and set terms as row names
...
graph <- visNetwork(nodes, edges) %>%
  ...
  visPhysics(
    ...
    forceAtlas2Based = list(
      ...
      centralGravity = 0.01,        # pull nodes toward center
      springLength = 100,           # adjust length of edges
      springConstant = 0.08,        # adjust stiffness of edges
      damping = 0.4,                # control speed of the simulation
